...
public record KakaoOAuth2Response(
  ...
  public static KakaoOAuth2Response from(Map<String, Object> attributes){
    return new KakaoOAuth2Response(
        ...
        (Map<String, Object>)attributes.get("properties"), // attributes.properties
        KakaoAccount.from((Map<String, Object>)attributes.get("kakao_account")) // attributes.kakao_account
    );
  }
  ...
  public record KakaoAccount (
      ...
      public static KakaoAccount from(Map<String, Object> attributes){ // attributes.kakao_account
      ...
      public record Profile(String nickname){
        public static Profile from(Map<String, Object> attributes){ // attributes.kakao_account.profile
