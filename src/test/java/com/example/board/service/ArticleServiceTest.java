...
class ArticleServiceTest {
  ...
  @Test
  void givenNonexistArticleId_whenUpdatingArticle_thenLogsWarningAndDoesNothing() {
    // Given
    ArticleDto dto = createArticleDto("새 타이틀", "새 내용 springboot");
  ...
  void givenModifiedArticleInfoWithDifferentUser_whenUpdatingArticle_thenDoesNothing() {
    ...
    given(userAccountRepository.getReferenceById(dto.userAccountDto().userId())).willReturn(dto.userAccountDto()
        .toEntity());
  ...
  @DisplayName("게시글 ID, 유저 ID를 입력하면, 게시글을 삭제한다.")
  @Test
