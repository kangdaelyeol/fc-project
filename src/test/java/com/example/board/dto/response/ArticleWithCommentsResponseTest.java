...
class ArticleWithCommentsResponseTest  {
  ...
  ArticleCommentDto createArticleCommentDto(Long id, Long parentCommentId, LocalDateTime localDateTime) {
    return ArticleCommentDto.of(id,
        1L,
  ...
  ArticleWithCommentsDto createArticleWithCommentDto(Set<ArticleCommentDto> articleCommentDtos){
  ...
  ArticleCommentResponse createArticleCommentResponse(Long id, Long parentCommentId, LocalDateTime localDateTime) {
